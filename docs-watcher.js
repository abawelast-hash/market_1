...
function getFileDescription(filePath) {
  ...
  const knownFiles = {
    ...
    'routes/qr.js': 'مسارات QR Code + الضمان الرقمي (Escrow)',
    'routes/stats.js': 'مسارات الإحصائيات',
    'routes/loyalty.js': 'مسارات نظام الولاء والنقاط (Market Coins)',
    ...
    'public/js/loyalty.js': 'واجهة نظام الولاء والنقاط',
    'database/generate_simulation.py': 'مولّد بيانات المحاكاة V1 (1,200 متجر)',
    'database/generate_souq_v2.py': 'مولّد سوق الرقة V2 (1,500 متجر، 25,000 منتج)',
